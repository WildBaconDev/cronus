package br.com.dg.panteao.cronus.security
...
class JWTUtil(
    ...
    private val expiration: Long = 60 * 60 * 1000

    @Value("\${jwt.secret}")
    private lateinit var secret: String

    fun generateToken(username: String, authorities: MutableCollection<out GrantedAuthority>? = null): String? =
        Jwts.builder()
            .setSubject(username)
