...
ENTRYPOINT ["java","-Dspring.data.mongodb.uri=mongodb+srv://admin:admin@cluster-panteao-db.mpxaf.mongodb.net/cronusDB?retryWrites=true&w=majority","-Dspring.profiles.active=prod","-jar","/app/cronus.jar"]
